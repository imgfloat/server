import { spawnUserJavaScriptWorker } from "./jsworkers.js"
import { canvas, canPlayProbe } from "./dom.js";
import { MIN_FRAME_TIME, VISIBILITY_THRESHOLD } from "./const.js"
...
fetchCanvasSettings().finally(() => {
    ...
    wsconnect(broadcaster, {
        onFetch: renderAssets,
        onWsEvent: onWebsocketEvent,
    });
});
